(() => {
    ...
    (() => {
        ...
        const pickerIn = datepicker_min(".data-input-in", {
            ...
            formatter: (input, date, instance) => {
                const checkInDate = date.toDateString();
                let value = checkInDate.split(" ");
                const day = value[0] + ",";
                let numb;
        ...
        const pickerOut = datepicker_min(".data-input-out", {
            customDays: [ "Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun" ],
            customMonths: [ "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December" ],
            overlayButton: "Submit",
            overlayPlaceholder: "4-digit year",
        ...
        pickerIn.getRange();
        pickerOut.getRange();
        flsModules.datepicker = pickerIn, pickerOut;
        ...
        function initSliders() {
            if (document.querySelector(".destinations__slider")) new core(".destinations__slider", {
                ...
                touchRatio: 1,
                navigation: {
                    prevEl: ".destinations__button_left",
                    nextEl: ".destinations__button_right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".offer__slider")) new core(".offer__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".offer__button_left",
                    nextEl: ".offer__button_right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".trip__slider")) new core(".trip__slider", {
                modules: [ Navigation ],
                observer: true,
                slidesPerView: 3.3,
                spaceBetween: 32,
            ...
            if (document.querySelector(".gallery__slider")) new core(".gallery__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".gallery__button_left",
                    nextEl: ".gallery__button_right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
